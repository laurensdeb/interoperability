...
test('It should return permissions for UMA token if resources match', async () => {
...
test('It should return no permissions for UMA token if resources match but permissions are empty', async () => {
  const permissionSet = await permissionReader.handle({identifier: resource,
...
test('It should not return permissions for UMA token if resources mismatch', async () => {
